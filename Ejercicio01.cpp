...
std::vector<int> paradasPorHacer(int maxKilometers, std::vector<int> gasolineras);

int main()
{
  std::vector<int> gasolineras = {1000, 1500, 500, 700, 2000, 3000};
  int maxKilometers = 3000;
  std::vector<int> resultado = paradasPorHacer(maxKilometers, gasolineras);
...
std::vector<int>  paradasPorHacer(int maxKilometers, std::vector<int> gasolineras)
{
  ...
  {
    if(kmRestantes + gasolineras[j+1] > maxKilometers)
    {
